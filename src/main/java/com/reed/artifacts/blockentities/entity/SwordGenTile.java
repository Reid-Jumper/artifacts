...
public class SwordGenTile extends AbstractGenTile {
    public SwordGenTile(BlockPos pos, BlockState state) {
        super(TileEntityInit.SWORD_GEN_BLOCK.get(), pos, state);
    }

    public static ArtifactType artifactType = ArtifactType.FORGOTTEN_SWORD;
