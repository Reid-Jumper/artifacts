...
public class BootsGenTile extends AbstractGenTile {
    public BootsGenTile(BlockPos pos, BlockState state) {
        super(TileEntityInit.BOOTS_GEN_BLOCK.get(), pos, state);
    }

    public static ArtifactType artifactType = ArtifactType.FORGOTTEN_BOOTS;
