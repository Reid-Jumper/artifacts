...
public class HelmGenTile extends AbstractGenTile {
    public HelmGenTile(BlockPos pos, BlockState state) {
        super(TileEntityInit.HELM_GEN_BLOCK.get(), pos, state);
    }

    public static ArtifactType artifactType = ArtifactType.FORGOTTEN_HELM;
