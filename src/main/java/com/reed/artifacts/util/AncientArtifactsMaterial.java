...
public enum AncientArtifactsMaterial implements ArmorMaterial {
    ANCIENT_ARTIFACT("ancient_artifacts", 20, new int[]{7, 15, 20, 8}, 50, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.1F, () -> {
        return Ingredient.of(ItemInit.FORGOTTEN_HELM.get());
    }),
    ANCIENT_ARTIFACT_BOOTS("ancient_artifacts_boots", 20, new int[]{7, 15, 20, 8}, 50, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.5F, () -> {
